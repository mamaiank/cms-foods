<?php
    echo $this->crud_model->clear_cache();
?>
...
<head>
	...
	<link href="<?php echo base_url(); ?>template/back/plugins/bootstrap-timepicker/bootstrap-timepicker.css" rel="stylesheet">


	<!--Bootstrap Validator [ OPTIONAL ]-->
	<link href="<?php echo base_url(); ?>template/back/plugins/bootstrap-validator/bootstrapValidator.css" rel="stylesheet">
