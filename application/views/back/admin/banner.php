...
//                            'after_most_viewed'
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-sm-12" align="center">
                                                                Size : <label style="color: red">255x160px</label>
                                            ...
                                            ?>
                                                <div class="panel panel-bordered-grey">
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-sm-12">
                                                                <label style="color: red">263x460px</label>
                                                                <span class="pull-left btn btn-default btn-file">
                                                                    <?php echo translate('select_banner_image');?>
                                                                    <input type="file" name="img" class="form-control imgInp" accept="image">
                                                                </span>
                ...
                <div class="col-xs-12">
                    <div>
                        <div><h3 style="margin-top: 0;">หมายเหตุ</h3></div>
                        <ul>
                            <li>กรณีเปิดใช้ Banner 1 อัน <label style="color: red">1110x190px</label> (ทั่งนี้เพื่อความสวยงามของเว็บไซต์)</li>
                            <li>กรณีเปิดใช้ Banner 2 อัน <label style="color: red">540x150px</label> (ทั่งนี้เพื่อความสวยงามของเว็บไซต์)</li>
                            <li>กรณีเปิดใช้ Banner 3 อัน <label style="color: red">350x140px</label> (ทั่งนี้เพื่อความสวยงามของเว็บไซต์)</li>
                            <li>กรณีเปิดใช้ Banner 4 อัน <label style="color: red">255x160px</label> (ทั่งนี้เพื่อความสวยงามของเว็บไซต์)</li>
                        </ul>
                    </div>
                </div>
