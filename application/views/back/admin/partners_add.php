<div>
    <?php
    echo form_open(base_url() . 'index.php/admin/partners/do_add/', array(
        ...
        <div class="form-group">
            ...
            <div class="col-sm-12">
                <input type="text" name="partners_name" id="demo-hor-1"
                       class="form-control required" placeholder="<?php echo translate('partners_name'); ?>">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-12" for="demo-hor-1">
            ...
            <div class="col-sm-12">
                <input type="text" name="partners_link" id="demo-hor-1"
                       class="form-control required" placeholder="<?php echo translate('partners_link'); ?>">
            </div>
        </div>
<!--         <div class="form-group">
            <label class="col-sm-12" for="demo-hor-1">
            ...
            <div class="col-sm-12">
                <input type="text" name="partners_name_en" id="demo-hor-1"
                       class="form-control required" placeholder="<?php echo translate('partners_name_eng'); ?>">
            </div>
        </div> -->
...
<!--         <div class="form-group">
            ...
            <div class="col-sm-12">
                <textarea class="tinymce" name='partners_detail'></textarea>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-12" for="demo-hor-1">
            ...
            <div class="col-sm-12">
                <textarea class="tinymce" name='partners_detail_en'></textarea>
            </div>
        </div> -->
