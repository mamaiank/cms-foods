    ...
    <table id="demo-table" class="table table-striped"  data-pagination="true" data-show-refresh="true" data-ignorecol="0,6" data-show-toggle="true" data-show-columns="false" data-search="true" >
        <thead>
            <tr>
                ...
                <!-- <th><?php echo translate('promotion');?></th> -->
        ...
        <tr>
            ...
            <td>
                <input id="pro_<?php echo $row['product_id']; ?>" class='sw3' type="checkbox" data-id='<?php echo $row['product_id']; ?>' <?php if($row['promotion'] == 'ok'){ ?>checked<?php } ?> />
            </td> -->
            <td class="text-right">
