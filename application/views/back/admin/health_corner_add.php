<div>
    <?php
    echo form_open(base_url() . 'index.php/admin/health_corner/do_add/', array(
        'class' => 'form-horizontal',
        'method' => 'post',
        'id' => 'health_corner_add',
    ...
    <div class="panel-body">
        <div class="form-group">
            ...
            <div class="col-sm-12">
                <input type="text" name="corner_name" id="demo-hor-1"
                       class="form-control required" placeholder="<?php echo translate('corner_name'); ?>">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-12" for="demo-hor-1">
            ...
            <div class="col-sm-12">
                <input type="text" name="corner_name_en" id="demo-hor-1"
                       class="form-control required" placeholder="<?php echo translate('corner_name_eng'); ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-12">
                <textarea class="tinymce" name='corner_detail'></textarea>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-12" for="demo-hor-1">
            ...
            <div class="col-sm-12">
                <textarea class="tinymce" name='corner_detail_en'></textarea>
            </div>
        </div>
