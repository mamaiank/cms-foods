<div class="panel" style="padding-top: 38px">
    <?php
    echo form_open(base_url() . 'index.php/admin/policy/do_add/', array(
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-12">
                    <input type="text" name="policy_name" id="policy_name" class="form-control required" value="">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-12 control-label text-left">
            ...
            <div class="col-sm-12">
                    <textarea class="tinymce" name='policy_detail'></textarea>
            </div>
        </div>
    </div>
