<div id="content-container">
    <div id="page-title">
        <h1 class="page-header text-overflow" ><?php echo translate('intro');?></h1>
    </div>
    <div class="tab-base">
        <div class="panel">
                ...
                <div class="tab-content">
                    <!-- <div style="border-bottom: 1px solid #ebebeb;padding: 25px 5px 5px 5px;"
                        ...
                        <button class="btn btn-primary btn-labeled fa fa-plus-circle pull-right mar-rgt"
                                onclick="ajax_set_full('add','<?php echo translate('intro_add'); ?>','<?php echo translate('successfully_added!'); ?>','intro_add','')">
                            <?php echo translate('intro_add');?>
                        </button>
                    </div> -->
                    <br>
