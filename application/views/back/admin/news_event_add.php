<div>
    <?php
    echo form_open(base_url() . 'index.php/admin/event_activity/do_add/', array(
        'class' => 'form-horizontal',
        'method' => 'post',
        'id' => 'event_activity_add',
    ...
    <div class="panel-body">
        <div class="form-group">
            ...
            <div class="col-sm-12">
                <input type="text" name="activity_name" id="demo-hor-1"
                       class="form-control required" placeholder="<?php echo translate('activity_name'); ?>">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-12" for="demo-hor-1">
            ...
            <div class="col-sm-12">
                <input type="text" name="activity_name_en" id="demo-hor-1"
                       class="form-control required" placeholder="<?php echo translate('activity_name_eng'); ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-12">
                <textarea class="tinymce" name='activity_detail'></textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-12">
                <textarea class="tinymce" name='activity_detail_en'></textarea>
            </div>
        </div>
