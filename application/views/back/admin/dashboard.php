...
<script async defer
		src="https://maps.googleapis.com/maps/api/js?key=AIzaSyATW_2adn-BGPMX3DrR3AwqezwPuZNjnGE&callback=initialize">
</script>
<script src="<?php echo base_url(); ?>template/back/js/markerclusterer.js"></script>
