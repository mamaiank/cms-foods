        ...
        <tr class="<?php if($row['viewed'] !== 'ok'){ echo 'pending'; } ?>" >
            ...
            <td class="text-right">
                ...
                <a class="btn btn-info btn-xs btn-labeled fa fa-file-text" data-toggle="tooltip" 
                    onclick="proceed('to_list'); ajax_set_full('view','<?php echo translate('title'); ?>','<?php echo translate('successfully_edited!'); ?>','sales_view','<?php echo $row['sale_id']; ?>')"
                ...
                <a class="btn btn-warning btn-xs btn-labeled fa fa-file-text" data-toggle="tooltip"
                   onclick="ajax_modal('delivery','แจ้งส่งสินค้า','แจ้งส่งสินค้า สำเร็จ!','delivery','<?php echo $row['sale_id']; ?>')">แจ้งส่งสินค้า
                </a>
