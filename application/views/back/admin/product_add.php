...
<!--                                               <span class="input-group-addon"><i></i></span>-->
                        ...
                        <div id="product_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('product_title_eng');?></label>
                                <div class="col-sm-6">
                                    <input type="text" name="title_en" id="demo-hor-1" placeholder="<?php echo translate('product_title_eng');?>" class="form-control required">
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-12" for="demo-hor-13"><?php echo translate('description'); ?></label>
                                <div class="col-sm-12">
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-12" for="demo-hor-13"><?php echo translate('description_eng'); ?></label>
                                <div class="col-sm-12">
                                    <textarea class="tinymce" name="description_en"></textarea>
                                </div>
                            </div>
    ...
    $(function() {
        ...
        $("#more_btn").on('click',function () {
            $("#more_additional_fields").append(''
                ...
                +'    </div>'
                +'    <div class="col-sm-2">'
                +'        <span class="remove_it_v rms btn btn-danger btn-icon btn-circle icon-lg fa fa-times"></span>'
                +'    </div>'
                +'    <div class="col-sm-12">'
                +'        <textarea class="tinymce" name="ad_field_values[]"></textarea>'
                +'    </div>'
                +'</div>'
            );
            set_summer();
        ...
        $("#more_option_btn").on('click',function () {
            option_count('add');
            ...
            $("#more_additional_options").append(''
                ...
                +'    <div class="col-sm-2">'
                +'        <span class="remove_it_o rmo btn btn-danger btn-icon btn-circle icon-lg fa fa-times"></span>'
                +'    </div>'
                +'</div>'
            );
            set_select();
        ...
        $("#more_additional_options").on('click','.add_op',function(){
            ...
            $(this).closest('.col-sm-12').find(".options").append(''
                ...
                +'        </div>'
                +'        <div class="col-sm-2">'
                +'          <span class="remove_it_n rmon btn btn-danger btn-icon btn-circle icon-sm fa fa-times"></span>'
                +'        </div>'
                +'    </div>'
            );
        });
