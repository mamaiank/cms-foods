<div class="panel" style="padding-top: 38px">
    ...
    ?>
    <?php
    echo form_open(base_url() . 'index.php/admin/store_locations/update/'.$store['id'], array(
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-12">
                <input type="text" name="store_name" id="store_name" class="form-control required" value="<?=$store['store_name']?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <?php
            $images = $this->crud_model->file_view('store_locations', $store['id'], '', '', 'thumb', 'src', '', 'all');
            ?>
            <div class="col-sm-12">
        ...
        <div class="form-group">
            <div class="col-md-offset-4 col-xs-8">
                    <span id="previewImgCover" style="padding: 10px">
                        <img class="img-thumbnail" width="250" src="<?php echo $images; ?>" alt="<?= $data['store_name'] ?>">
                    </span>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-12">
                <textarea class="tinymce" name='store_detail'><?=$store['store_detail']?></textarea>
            </div>
        </div>
        ...
        <div class="form-group btm_border">
            ...
            <div class="col-sm-6">
                <?php 
                    $images = $this->crud_model->file_view('store_locations',$store['id'],'','','thumb','src','multi_id','all');
                    if($images){
        ...
        <div class="form-group">
            ...
            <!-- <div class="col-sm-4">
                <input type="text" name="latitude" id="latitude" class="form-control required" value="<?=$store['latitude']?>">
            </div>
            <div class="col-sm-4">
                <input type="text" name="longitude" id="longitude" class="form-control required" value="<?=$store['longitude']?>">
            </div> -->
            <div class="col-sm-12">
                <div class="col-sm-12">
                    <textarea class="form-control" name='map_zoom'><?=$store['map_zoom']?></textarea>
                </div>
        ...
        <div class="form-group">
            ...
            <?php
            $images = $this->crud_model->file_view('store_locations_map', $store['id'], '', '', 'thumb', 'src', '', 'all');
            ?>
            <div class="col-sm-12">
        ...
        <div class="form-group">
            <div class="col-md-offset-4 col-xs-8">
                    <span id="previewImgMap" style="padding: 10px">
                        <img class="img-thumbnail" width="250" src="<?php echo $images; ?>" alt="<?= $data['store_name'] ?>">
                    </span>
            </div>
        </div>
            ...
            <div class="col-xs-12">
                ...
                <script>
                    ...
                    function initMap() { // ฟังก์ชันแสดงแผนที่
                        ...
                        var my_Latlng  = new GGM.LatLng(<?=$store['latitude']==""?"13.7596336":$store['latitude']?>,<?=$store['longitude']==""?"100.6140252":$store['longitude']?>);
                        var my_mapTypeId=GGM.MapTypeId.ROADMAP; // กำหนดรูปแบบแผนที่ที่แสดง
                        // กำหนด DOM object ที่จะเอาแผนที่ไปแสดง ที่นี้คือ div id=map_canvas
                        var my_DivObj=$("#map")[0];
                        // กำหนด Option ของแผนที่
                        var myOptions = {
                            zoom: <?=$store['map_zoom']==""?"15":$store['map_zoom'];?>, // กำหนดขนาดการ zoom
                ...
                <script async defer
                        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyATW_2adn-BGPMX3DrR3AwqezwPuZNjnGE&callback=initMap"></script>
            </div>
        </div> -->
    </div>
