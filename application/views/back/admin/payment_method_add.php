<div>
    <?php
    echo form_open(base_url() . 'index.php/admin/payment_method/do_add/', array(
        'class' => 'form-horizontal',
        'method' => 'post',
        'id' => 'payment_method_add',
    ...
    <div class="panel-body">
        <div class="form-group">
            ...
            <div class="col-sm-12">
                <input type="text" name="payment_name" id="demo-hor-1"
                       class="form-control required" placeholder="<?php echo translate('payment_name'); ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-12">
                <textarea class="tinymce" name='payment_detail'></textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-12">
                <select name="payment_type" class="form-control">
                    ...
                    <option value="5"><?php echo translate('online_banking'); ?></option>
                    <option value="2"><?php echo translate('counter_service'); ?></option>
                </select>
            </div>
        </div>
