<div>
    <?php
    echo form_open(base_url() . 'index.php/admin/founder_message/do_add/', array(
        'class' => 'form-horizontal',
        'method' => 'post',
        'id' => 'founder_message_add',
    ...
    <div class="panel-body">
        <div class="form-group">
            ...
            <div class="col-sm-12">
                <input type="text" name="message_title" id="demo-hor-1"
                       class="form-control required" placeholder="<?php echo translate('message_title'); ?>">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-12" for="demo-hor-1">
            ...
            <div class="col-sm-12">
                <input type="text" name="message_title_en" id="demo-hor-1"
                       class="form-control required" placeholder="<?php echo translate('message_title_eng'); ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-12">
                <textarea class="tinymce" name='message_detail'></textarea>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-12" for="demo-hor-1">
            ...
            <div class="col-sm-12">
                <textarea class="tinymce" name='message_detail_en'></textarea>
            </div>
        </div>
