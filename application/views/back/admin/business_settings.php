    ...
    <div class="tab-base">
        <div class="tab-base tab-stacked-left">
            <?php
                ...
                $shipment_condition = $this->db->get_where('business_settings', array(
                    'type' => 'shipment_condition'
                ))->row()->value;
                $shipment_condition_detail = $this->db->get_where('business_settings', array(
                    'type' => 'shipment_condition_detail'
                ))->row()->value;
...
<!--                        </div>-->
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo translate('shipment_condition');?></label>
                            <div class="col-sm-6">
                                <input type="text" name="shipment_condition" id='shipment_condition' value="<?php echo $shipment_condition; ?>" class="form-control">
                                <label>เช่น 1000 จัดส่งฟรี</label>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo translate('shipment_condition_detail');?></label>
                            <div class="col-sm-6">
                                <input type="text" name="shipment_condition_detail" id='shipment_condition_detail' value="<?php echo $shipment_condition_detail; ?>" class="form-control">
                                <label>คำอธิบายเงื่อนไขการจัดส่ง</label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-12"><?php echo translate('shipment_info');?></label>
                            <div class="col-sm-12">
                                <textarea class="tinymce" name="shipment_info"><?php echo $shipment_info; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
