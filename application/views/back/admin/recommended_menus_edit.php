...
foreach ($menu_data as $data) {
    ...
    <div class="tab-pane fade active in" id="edit">
        <?php
        echo form_open(base_url() . 'index.php/admin/recommended_menus/update/' . $data['id'], array(
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <input type="text" name="menu_name" id="demo-hor-1"
                           class="form-control required" value="<?= $data['menu_name'] ?>"
                           placeholder="<?php echo translate('menu_name'); ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-12" for="demo-hor-1">
                ...
                <div class="col-sm-12">
                    <input type="text" name="menu_name_en" id="demo-hor-1"
                           class="form-control required" value="<?= $data['menu_name_en'] ?>"
                           placeholder="<?php echo translate('menu_name_eng'); ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <textarea class="tinymce" name='menu_detail'><?= $data['menu_detail'] ?></textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <textarea class="tinymce" name='menu_detail_en'><?= $data['menu_detail_en'] ?></textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <?php
                $images = $this->crud_model->file_view('recommended_menus', $data['id'], '', '', 'thumb', 'src', '', 'all');
                ?>
                <div class="col-sm-12">
					<span class="pull-left btn btn-default btn-file"> <?php echo translate('choose_file'); ?> (270 x 170 px)
            ...
            <div class="form-group">
                <div class="col-md-offset-4 col-xs-8">
						<span id="previewImg" style="padding: 10px">
							<img class="img-thumbnail" width="250" src="<?php echo $images; ?>" alt="<?= $data['menu_name'] ?>">
						</span>
                </div>
            </div>
