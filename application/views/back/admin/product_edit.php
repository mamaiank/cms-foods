                ...
                <div class="tab-base">
                    ...
                    <div class="tab-content">
                        <div id="product_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1">
                                    <?php echo translate('product_title_eng');?>
                                        </label>
                                <div class="col-sm-6">
                                    <input type="text" name="title_en" id="demo-hor-1" value="<?php echo $row['title_en']; ?>" placeholder="<?php echo translate('product_title_eng');?>" class="form-control required">
                                </div>
                            </div>
                            <div class="form-group btm_border">
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-12" for="demo-hor-14">
                                    <?php echo translate('description');?>
                                        </label>
                                <div class="col-sm-12">
                                    <textarea rows="9" class="tinymce" name="description">
                                        <?php echo $row['description']; ?></textarea>
                                </div>
                            </div>
                            <div class="form-group btm_border">
                                <label class="col-sm-12" for="demo-hor-14">
                                    <?php echo translate('description_eng');?>
                                        </label>
                                <div class="col-sm-12">
                                    <textarea rows="9" class="tinymce" name="description_en">
                                        <?php echo $row['description_en']; ?></textarea>
                                </div>
                            </div>
                            <?php
                            ...
                            ?> 
                                <div class="form-group btm_border">
                                    ...
                                    <div class="col-sm-12">
                                        <textarea rows="9"  class="tinymce" name="ad_field_values[]"><?php echo $row1['value']; ?></textarea>
                                    </div>
                                </div>
                            <?php
                                    }
...
<script type="text/javascript">
	...
	function set_summer(){
        tinymce.init({
            ...
            toolbar2: "| responsivefilemanager | link unlink anchor | image media | forecolor backcolor fontsizeselect  | print preview code fullscreen",
            image_advtab: true ,
...
//		});
    ...
    $("#more_btn").click(function(){
        $("#more_additional_fields").append(''
            ...
            +'    </div>'
            +'    <div class="col-sm-12">'
            +'        <textarea rows="9" class="tinymce" name="ad_field_values[]"></textarea>'
            +'    </div>'
            +'</div>'
        );
        set_summer();
