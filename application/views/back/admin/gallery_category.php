				...
				<div class="tab-content">
					<div style="border-bottom: 1px solid #ebebeb;padding: 25px 5px 5px 5px;"
						...
						<button class="btn btn-primary btn-labeled fa fa-plus-circle pull-right mar-rgt" 
                        	onclick="ajax_modal('add','<?php echo translate('add_gallery_category'); ?>','<?php echo translate('successfully_added!'); ?>','gallery_category_add','')">
								<?php echo translate('create_gallery_category');?>
                                	</button>
					</div>
					<br>
