	<div class="panel-body" id="demo_s">
		<table id="demo-table" class="table table-striped"  data-pagination="true" data-show-refresh="true" data-ignorecol="0,2" data-show-toggle="true" data-show-columns="false" data-search="true" >
			...
			<tr>
				...
				<td>
					<?php
					$images = $this->crud_model->file_view('payment_method', $row['id'], '', '', 'thumb', 'src', '', 'all');
					?>
				...
				<td class="text-right">
					<a class="btn btn-success btn-xs btn-labeled fa fa-wrench" data-toggle="tooltip" 
                    	onclick="ajax_set_full('edit','<?php echo translate('payment_method_edit'); ?>','<?php echo translate('successfully_edited!'); ?>','payment_method_edit','<?php echo $row['id']; ?>')"
	...
	<div id='export-div'>
		<h1 style="display:none;"><?php echo translate('payment_method'); ?></h1>
		<table id="export-table" data-name='payment_method' data-orientation='p' style="display:none;">
				<thead>
					<tr>
						<th><?php echo translate('no');?></th>
						<th><?php echo translate('name');?></th>
