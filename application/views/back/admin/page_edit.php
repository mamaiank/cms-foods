                                	...
                                	<div class="panel panel-bordered panel-info">
                                		...
                                		<div class="panel-body">
                                   		 ...
                                   		 <div class="col-sm-12 content" <?php if($type !== 'content'){ ?>style="display:none;"<?php } ?>>
                                				<div class="abstract">
                                					<textarea rows="9"  class="tinymce" data-height="400" data-name="part_content[]" name="part_content[]"><?php echo $content; ?></textarea>
                                   		 	</div>
                                   		 </div>
                                		</div>
                                	</div>
    ...
    <script>
		...
		$("#part_num").click(function(){
			...
			htmls =	htmls
				...
				+'				<div class="abstract">'
				+'					<textarea rows="9"  class="tinymce" data-height="400" data-name="part_content[]" name="part_content[]"></tinymcerea>'
				+'   		 	</div>'
				+'   		 </div>'
				+'		</div>';
				+'	</div>';
