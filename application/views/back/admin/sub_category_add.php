	...
	?>
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="sub_category_name_en" placeholder="<?php echo translate('sub-category_name_eng'); ?>" class="form-control required">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="description" placeholder="<?php echo translate('sub-category_description'); ?>" class="form-control required">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4 control-label" for="demo-hor-1">
                ...
                <div class="col-sm-6">
                    <input type="text" name="description_en" placeholder="<?php echo translate('sub-category_description_eng'); ?>" class="form-control required">
                </div>
            </div>
            <div class="form-group">
