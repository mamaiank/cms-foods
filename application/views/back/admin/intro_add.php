<div>
    <?php
    echo form_open(base_url() . 'index.php/admin/intro/do_add/', array(
    ...
    <div class="panel-body">
        <div class="form-group">
            ...
            <div class="col-sm-12">
                <input type="text" name="intro_title" id="demo-hor-1"
                       class="form-control required" placeholder="<?php echo translate('intro_title'); ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-12">
                <span id="previewImgbackground" style="padding: 10px"></span>
                    <span class="pull-left btn btn-default btn-file"> <?php echo translate('choose_file'); ?> (1350 x 350 px)
                        <input type="file" multiple name="backgroundimages" onchange="preview_background(this);" id="demo-hor-12"
