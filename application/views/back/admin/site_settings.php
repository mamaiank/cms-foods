...
<!--                                    </div>-->
                    ...
                    <div id="demo-stk-lft-tab-2" class="tab-pane">
                            ...
                            ?>
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="input-group mar-btm">
                                                <span class="input-group-addon instagram_font">
                                                    <i class="fa fa-instagram fa-lg"></i>
                                                </span>
                                                <input type="text" name="instagram" value="<?php echo $this->crud_model->get_type_name_by_id('social_links','7','value'); ?>" id="demo-hor-inputemail" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                ...
                ?>
                    ...
                    <div id="demo-stk-lft-tab-p" class="tab-pane fade">
                        <div class="panel">
                            ...
                            ?>
                                <div class="panel-body">
                                    <textarea class="tinymce" data-height='700' data-name='privacy_policy' name="privacy_policy"><?php echo $privacy_policy; ?></textarea>
                                    <!--===================================================-->
                                    <!-- End Summernote -->
                                </div>
                                <div class="panel-footer text-right">
                    ...
                    <div id="demo-stk-lft-tab-6" class="tab-pane fade">
                        <div class="panel">
                            ...
                            ?>
                                <div class="panel-body">
                                    <textarea class="tinymce" data-height='700' data-name='terms' name="terms"><?php echo $terms_conditions; ?></textarea>
                                    <!--===================================================-->
                                    <!-- End Summernote -->
                                </div>
                                <div class="panel-footer text-right">
                            ...
                            ?>
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="col-sm-">
                                                <textarea class="tinymce" data-height='400' data-name='contact_about' name="contact_about"><?php echo $contact_about; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            ?>
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="col-sm-">
                                                <textarea class="tinymce" data-height='400' data-name='footer_text' name="footer_text"><?php echo $footer_text; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
...
<!--                                            <div class="col-sm-6">-->
<!--                                                <div class="delete-div-wrap cc-selector">-->
<!--                                                    <input id="header_color_ztopy" type="radio" value="ztopy" name="header_color" --><?php //if($header_color == 'ztopy'){ echo 'checked'; } ?><!-- >-->
<!--                                                    <label class="tr-bg drinkcard-cc" for="header_color_ztopy"-->
<!--                                                           style="margin-bottom:0px;-->
<!--                                                            background:white">-->
<!--                                                        <img src="--><?php //echo base_url() ?><!--uploads/scheme/grey.jpg" width="100%" />-->
<!---->
