<div class="panel-body" id="demo_s">
    <table id="demo-table" class="table table-striped"  data-pagination="true" data-show-refresh="true" data-ignorecol="0,3" data-show-toggle="false" data-show-columns="false" data-search="true" >
        ...
        <tr>
            ...
            <td>
                <img  class="img-responsive thumbnail img-slider mr-none" src="<?php echo base_url(); ?>uploads/slider_image/background_<?php echo $row['slider_id']; ?>.jpg" />Image size:<label style="color: #FF0000">1354x500px</label>
            </td>
            <td>
