		...
		<div class="container">
			...
			<div class="group-spafoods">
				<div class="row">
					...
					<div class="col-sm-3">
						<div class="thumbnail">
							<a href="<?php echo base_url(); ?>index.php/home/health_detail/<?= $r['id'] ?>">
								<img alt="" src="<?php echo $this->crud_model->file_view('health_corner',$r['id'],'','','thumb','src','','one'); ?>" />
								<div class="caption">
									<?php 
										$title = $this->nookcs_model->getDataMultiLanguage($r['corner_name'],$r['corner_name_en']);
									?>
									<?= $title ?>
