            ...
            <div class="col-md-3 md-margin-bottom-40" align="center">
                ...
                <?php } ?>
                    ...
                    <tbody>
                        <tr>
                            <td colspan="2">
                                <center><h4 style="margin-top: 0;"><?php echo translate('personal_information');?></h4></center>
                            </td>                          
                        </tr>
                        <tr>
                                            ...
                                            <fieldset>                  
                                                ...
                                                <section class="col-md-8">
                                                    <label class="input">
                                                        ...
                                                        <input type="text" name="birthday" class="required birthday-datepicker" value="<?php echo $row['birthday'];?>" data-mask="99-99-9999">
                                                        <b class="tooltip tooltip-right"><?php echo translate('birthday'); ?></b>
                                                    </label>
                                                </section>
                                                    ...
                                                    <ul class="list-unstyled checkbox-list register-checkbox">
                                                        <li>
                                                            <label class="radio state-success">
                                                                <input type="radio" name="checkbox_gender" class="check_category" value="m" <?=$row['gender']=="m"?"checked":"";?>  />
                                                        ...
                                                        <li>
                                                            <label class="radio state-success">
                                                                <input type="radio" name="checkbox_gender" class="check_category" value="f" <?=$row['gender']=="f"?"checked":"";?> />
                                                                <i class="rounded-x" style="font-size:30px !important;"></i>
