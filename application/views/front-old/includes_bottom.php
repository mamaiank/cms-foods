...
<script src="<?php echo base_url(); ?>template/front/assets/plugins/jasny-bootstrap/js/jasny-bootstrap.min.js"></script>
...
<!-- JS Customization -->
<script src="<?php echo base_url(); ?>template/front/assets/js/plugins/printThis.js"></script>
...
<script type="text/javascript" src="<?php echo base_url(); ?>template/front/assets/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>template/front/assets/plugins/bootstrap-datepicker/js/locales/bootstrap-datepicker.th.js"></script>
...
<script type="text/javascript" src="<?php echo base_url(); ?>template/front/assets/plugins/css3-animate/js/css3-animate-it.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>template/front/assets/plugins/glasscase/js/jquery.glasscase.js"></script>

    <?php
        if($page_name=="gallery_view"){
    ?>
            <script type="text/javascript" src="<?php echo base_url(); ?>template/front/assets/plugins/fotorama/fotorama.js"></script>
    <?php
        }
    ?>
<?php
        ...
        $.fancybox.open([
            {
                    ...
                    padding : 0,
                    href: 'http://www.heelcarethailand.com/index.php/home/thankyou',
                    type: 'iframe'
...
//            {
//                padding : 0,
//                href: '<?php //echo base_url();?>//images/popup2.jpg',
//            }
//        ], {
//            helpers : {
//                thumbs : {
...
<script>
    ...
    $(document).ready(function() {
        ajax_load('<?php echo base_url(); ?>index.php/home/cart/added_list/','added_list','<?=$code;?>');
    	<?php
...
<script type="text/javascript">
    /* <![CDATA[ */
    var google_conversion_id = 864799360;
...
<noscript>
    <div style="display:inline;">
        <img height="1" width="1" style="border-style:none;" alt="" src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/864799360/?guid=ON&amp;script=0"/>
    </div>
</noscript>
