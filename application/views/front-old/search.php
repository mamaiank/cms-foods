...
<input type="hidden" name="chk_search" id="chk_search">
<input type="hidden" name="text_search" id="text_search" value="<?=$_GET['textSearch'];?>">
</form>
<?php
//var_dump($_GET['textSearch']);
?>
<script>
    var add_to_cart = '<?php echo translate('add_to_cart'); ?>';
    var base_url = '<?php echo base_url(); ?>';
    var search = '<?=$_GET['textSearch'];?>';
</script>
<script src="<?php echo base_url(); ?>template/front/assets/js/custom/search.js"></script>