                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 md-margin-bottom-40">
                            <center><a href="<?php echo base_url(); ?>">
                            	<img id="logo-footer" class="footer-logo" width='100%' style="max-width: 230px !important;"
                            ...
                            <div class="col-xs-12" style="margin-top: 20px" align="center">
                                ...
                                <script type="text/javascript">var _Hasync= _Hasync|| [];
                                    _Hasync.push(['Histats.start', '1,3712484,4,235,112,50,00011000']);
                                ...
                                <noscript><a href="/" target="_blank"><img  src="//sstatic1.histats.com/0.gif?3712484&101" alt="" border="0"></a></noscript>
                                <!-- Histats.com  END  -->
                            </div>
                        ...
                        <div class="col-md-3 md-margin-bottom-40">
                            ...
                            <ul class="list-unstyled link-list">
                                <li>
                                	<a href="<?php echo base_url(); ?>index.php/home/tracking">
                                    	<?php echo translate('product_tracking'); ?>
                                    </a>
                                    <i class="fa fa-angle-right"></i>
                                </li>
                                <li>
                                	<a href="<?php echo base_url(); ?>index.php/home/storeLocations">
                                    	<?php echo translate('branch'); ?>
                                    </a>
                                    <i class="fa fa-angle-right"></i>
                                </li>
                                <li>
                                	<a href="<?php echo base_url(); ?>index.php/home/confirm_payment">
                                    	<?php echo translate('confirm_payment'); ?>
                                    </a>
                                    <i class="fa fa-angle-right"></i>
                                </li>
                                <li>
                                	<a href="<?php echo base_url(); ?>index.php/home/policies/8">
                                        การรับประกันสินค้า
                                    </a>
                                    <i class="fa fa-angle-right"></i>
                                </li>
                        ...
                        <div class="col-md-3 md-margin-bottom-40">
                            ...
                            <ul class="social-icons">
                                ...
                                <li>
                                    <a href="<?php echo $instagram; ?>" data-original-title="<?php echo translate('instagram'); ?>"
                                       class="rounded-x social_instagram"></a>
                                </li>
                            </ul>
                            <!-- End Social Links -->
                        </div>
