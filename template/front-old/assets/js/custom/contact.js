    ...
    function initMap() {
        var uluru = {lat: 13.692849, lng: 100.5160823};
        var map = new google.maps.Map(document.getElementById('contact_map'), {
            zoom: 15,
            center: uluru
        });

        var contentString = '<div id="col-xs-12">'+
            '<div id="siteNotice">'+
            '</div>'+
            '<h1 id="firstHeading" class="firstHeading">heelcarethailand.com</h1>'+
            '<div id="bodyContent">'+
            '<p><b>Heel Care Thailand</b></p>' +
            '<p>611/210-213 Soi Watchannai Rama 3 Rd, Banklo, Bankolaem, Bangkok 10120, Thailand'+
            '</p>'+
            '<p>+66 91 890 3797</p><br>'+
            '</div>'+
            '</div>';
